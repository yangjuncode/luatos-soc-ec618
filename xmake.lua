...
includes(SDK_TOP .. "/project/" .. USER_PROJECT_NAME)
...
target(USER_PROJECT_NAME..".elf")
	...
	after_build(function(target)
		...
		os.exec(GCC_DIR .. "bin/arm-none-eabi-objcopy -O binary $(buildir)/"..USER_PROJECT_NAME.."/"..USER_PROJECT_NAME..".elf $(buildir)/"..USER_PROJECT_NAME.."/"..USER_PROJECT_NAME..".bin")
		os.exec("./PLAT/tools/fcelf.exe -M -input ./PLAT/tools/ap_bootloader.bin -addrname  BL_IMG_MERGE_ADDR -flashsize BOOTLOADER_FLASH_LOAD_SIZE -input $(buildir)/"..USER_PROJECT_NAME.."/"..USER_PROJECT_NAME..".bin -addrname  AP_IMG_MERGE_ADDR -flashsize AP_FLASH_LOAD_SIZE -input ./PLAT/prebuild/FW/lib/cp-demo-flash.bin -addrname CP_IMG_MERGE_ADDR -flashsize CP_FLASH_LOAD_SIZE -def ./PLAT/device/target/board/ec618_0h00/common/inc/mem_map.h -outfile " .. SDK_PATH .. "/out/" ..USER_PROJECT_NAME.."/"..USER_PROJECT_NAME..".binpkg")
